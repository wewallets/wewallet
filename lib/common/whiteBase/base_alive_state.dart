...
//通用标题
  Widget getAppBar(title, {leading = "swap_left", List<Widget> actions, double elevation: 0.0, onPressed, noLeading = false, textColor,colors}) {
    return getContextAppBar(context, title.toString().toUpperCase(), colors: colors??Color(0xFFFFFFFF), leading: leading, actions: actions, elevation: elevation, onPressed: onPressed, noLeading: noLeading, textColor: textColor, leftWidth: dp(32), leftHeight: dp(32));
  }
