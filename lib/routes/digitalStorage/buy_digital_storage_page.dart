...
class BuyDigitalStoragePage extends StatefulWidget {
  final Bundle bundle;

  BuyDigitalStoragePage(this.bundle);

  @override
  _BuyDigitalStoragePageState createState() => _BuyDigitalStoragePageState();
}

class _BuyDigitalStoragePageState extends BaseState<BuyDigitalStoragePage> {
