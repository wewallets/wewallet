...
import 'package:mars/routes/digitalStorage/assets_digital_storage_page.dart';
import 'package:mars/routes/digitalStorage/consignment_digital_storage_page.dart';
import 'package:mars/routes/digitalStorage/home_digital_storage_page.dart';
import 'package:mars/routes/digitalStorage/ledger_digital_storage_page.dart';
import 'package:mars/routes/digitalStorage/pool_digital_storage_page.dart';

//首页
class MainDigitalStoragePage extends StatefulWidget {
  @override
  _MainDigitalStoragePageState createState() => _MainDigitalStoragePageState();
}

class _MainDigitalStoragePageState extends State<MainDigitalStoragePage> with AutomaticKeepAliveClientMixin, TickerProviderStateMixin {
  @override
  ...
  var appBarIcons = [
    ['main_tab_0', 'main_tab_1'],
    ['main_tab_2', 'main_tab_3'],
    ['main_tab_4', 'main_tab_5'],
    ['main_tab_6', 'main_tab_7'],
  ];
  ...
  initTitle() async {
    ...
    _titles.add('${s.text12}');
    _titles.add('${s.kc}');
    _titles.add('${s.zc}');
    _pageList.add(HomeDigitalStoragePage());
    _pageList.add(ConsignmentDigitalStoragePage());
    _pageList.add(PoolDigitalStoragePage());
    _pageList.add(AssetsDigitalStoragePage());
            ...
            : Scaffold(
                ...
                bottomNavigationBar: Container(
                    ...
                    child: SafeArea(
                      ...
                      children: <Widget>[
                        Container(color: Color(0xFF212028), height: ScreenUtil().setWidth(2)),
                        Container(
                            height: ScreenUtil().setWidth(100),
                            decoration: BoxDecoration(color: Color(0xFF08070F)),
                            padding: EdgeInsets.only(top: ScreenUtil().setWidth(10)),
                            child: TabBar(
                              controller: _controller,
                              indicatorColor: Color(0xFF08070F),
  ...
  Color getColor(int curIndex) {
    if (curIndex == _controller.index) {
      return Color(0xFF3DF2F0);
    }
    return Color(0xFF184E53);
  }
}
