...
//选择币种
class SelectCurrencyTwoPage extends StatefulWidget {
  final Bundle bundle;

  SelectCurrencyTwoPage(this.bundle);

  @override
  _SelectCurrencyTwoPageState createState() => _SelectCurrencyTwoPageState();
}

class _SelectCurrencyTwoPageState extends BaseState<SelectCurrencyTwoPage> {
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            return InkWell(
                ...
                child: Column(
                  children: [
                    Container(
                      child: Text(model.name.toUpperCase(), style: TextStyles.textWhite14),
