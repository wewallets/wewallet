...
poolListsEntityFromJson(PoolListsEntity data, Map<String, dynamic> json) {
	if (json['log_list'] != null) {
		data.logList = (json['log_list'] as List).map((v) => PoolListsLogList().fromJson(v)).toList();
	}
...
Map<String, dynamic> poolListsEntityToJson(PoolListsEntity entity) {
...
poolListsLogListFromJson(PoolListsLogList data, Map<String, dynamic> json) {
	if (json['date'] != null) {
...
Map<String, dynamic> poolListsLogListToJson(PoolListsLogList entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
