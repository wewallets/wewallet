...
class SpWalletUtil {
  static SpWalletUtil _instance;

  static Future<SpWalletUtil> get instance async {
  ...
  static Future<SpWalletUtil> getInstance() async {
    if (_instance == null) {
      _instance = new SpWalletUtil._();
      await _instance._init();
    }
    return _instance;
  }

  static Future<SpWalletUtil> init() async {
    _instance = new SpWalletUtil._();
    await _instance._init();
    return _instance;
  }
