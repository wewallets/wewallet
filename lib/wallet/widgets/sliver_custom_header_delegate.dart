...
class SliverCustomHeaderDelegate extends SliverPersistentHeaderDelegate {
  ...
  Color makeStickyHeaderBlackTextColor(shrinkOffset, isIcon) {
    if (shrinkOffset <= 60 && isIcon) {
      return shrinkOffset <= 60 ? Colors.white :  Colours().textTheme1;
    } else {
      final int alpha = (shrinkOffset / (this.maxExtent - this.minExtent) * 255).clamp(0, 255).toInt();
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Row(children: <Widget>[
                InkWell(
                  child: Padding(
                      child: titleBackground == null ? LoadAssetImage(leftImage, width: adaptation(44), color: makeStickyHeaderBlackTextColor(shrinkOffset, true)) : LoadAssetImage(leftImage, width: adaptation(44)), padding: EdgeInsets.only(left: adaptation(20))),
                  onTap: () {
                ...
                Expanded(
                    child: Padding(
                        ...
                        padding: EdgeInsets.only(right: adaptation(64)))),
              ]),
            ),
          ),
        ],
