...
class BaseDialog extends StatefulWidget {
  BaseDialog({Key key, @required this.entryAnimation, @required this.widget, this.cornerRadius, this.height, this.width, this.backgroundColor, this.alignmentGeometry}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Dialog(
      ...
      child: Container(
        ...
        alignment: widget.alignmentGeometry ?? null,
        child: Material(
