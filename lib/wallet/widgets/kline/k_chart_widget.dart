    ...
    return StreamBuilder<InfoWindowEntity>(
        ...
        builder: (context, snapshot) {
          ...
          infos = [
            ...
            entity.change.toString(),
            entity.percent.toString()+'%',
            NumUtil.formatNum(entity.vol.toString(), 4).toString(),
          ];
          return Container(
            margin: EdgeInsets.only(left: snapshot.data.isLeft ? 4 : mWidth - mWidth / 3 - 4, top: 25),
            width: mWidth / 3,
            decoration: BoxDecoration(color: Colors.white, border: Border.all(color: Colors.white, width: 0.5), borderRadius: BorderRadius.all(Radius.circular(6))),
