...
class _MyUnderlinePainter extends BoxPainter {
  ...
  int get index => decoration.index;
  ...
  Rect _indicatorRectFor(Rect rect, TextDirection textDirection) {
    ...
    //希望的宽度
    double wantWidth = ScreenUtil().setWidth(66);
    if (index != null) {
      if (index == 0) {
        return Rect.fromLTWH( ScreenUtil().setWidth(5), indicator.bottom - borderSide.width, wantWidth, borderSide.width);
      } else if (index == 1) {
