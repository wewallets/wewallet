...
class TransactionWebSocket {
  factory TransactionWebSocket() => _getInstance();

  static TransactionWebSocket get instance => _getInstance();

  static TransactionWebSocket _instance;

  static TransactionWebSocket _getInstance() {
    if (_instance == null) {
      _instance = TransactionWebSocket._internal();
    }
    return _instance;
  }

  TransactionWebSocket._internal() {
    connect();
