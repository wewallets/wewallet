...
class MarketHomeSocket {
  factory MarketHomeSocket() => _getInstance();

  static MarketHomeSocket get instance => _getInstance();

  static MarketHomeSocket _instance;

  static MarketHomeSocket _getInstance() {
    if (_instance == null) {
      _instance = MarketHomeSocket._internal();
    }
    return _instance;
  }

  MarketHomeSocket._internal() {
    connect();
