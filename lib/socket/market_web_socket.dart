...
class MarketWebSocket {
  factory MarketWebSocket() => _getInstance();

  static MarketWebSocket get instance => _getInstance();

  static MarketWebSocket _instance;

  static MarketWebSocket _getInstance() {
    if (_instance == null) {
      _instance = MarketWebSocket._internal();
    }
    return _instance;
  }

  MarketWebSocket._internal() {
    connect();
